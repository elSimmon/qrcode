...
<head>
  ...
  <!-- Font Awesome Icons -->
  <link href="{{asset('argon/assets/css/font-awesome.css')}}" rel="stylesheet" />
  <link href="{{asset('argon/assets/css/nucleo-svg.css')}}" rel="stylesheet" />
  <!-- CSS Files -->
  <link href="{{asset('argon/assets/css/argon-design-system.css?v=1.2.2')}}" rel="stylesheet" />
</head>
...
<body class="landing-page">
  ...
  <!--   Core JS Files   -->
  <script src="{{asset('argon/assets/js/core/jquery.min.js')}}" type="text/javascript"></script>
  <script src="{{asset('argon/assets/js/core/popper.min.js')}}" type="text/javascript"></script>
  <script src="{{('argon/assets/js/core/bootstrap.min.js')}}" type="text/javascript"></script>
  <script src="{{asset('argon/assets/js/plugins/perfect-scrollbar.jquery.min.js')}}"></script>
  <!--  Plugin for Switches, full documentation here: http://www.jque.re/plugins/version3/bootstrap.switch/ -->
  <script src="{{asset('argon/assets/js/plugins/bootstrap-switch.js')}}"></script>
  <!--  Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/ -->
  <script src="{{asset('argon/assets/js/plugins/nouislider.min.js')}}" type="text/javascript"></script>
  <script src="{{asset('argon/assets/js/plugins/moment.min.js')}}"></script>
  <script src="{{asset('argon/assets/js/plugins/datetimepicker.js')}}" type="text/javascript"></script>
  <script src="{{asset('argon/assets/js/plugins/bootstrap-datepicker.min.js')}}"></script>
